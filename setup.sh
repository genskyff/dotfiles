...
# Arch
pacman_list="base-devel bat bottom curl dust fastfetch fd fish fzf git git-delta gitui libunwind lsd neovim net-tools ntp openbsd-netcat openssh ripgrep socat starship tokei unzip zellij zoxide"
yay_url=https://aur.archlinux.org/yay-bin.git
aur_list="git-credential-oauth ttf-maple"

# Debian
apt_list="bat build-essential curl fd-find fish git htop iptables libunwind8 lsd neofetch net-tools netcat-openbsd ntp openssh-client openssh-server ripgrep socat tmux unzip virt-what"
