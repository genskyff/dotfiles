...
$scoop_list = "7zip bat delta fastfetch fzf git gsudo lazydocker lazygit less llvm lsd mingw-winlibs-ucrt mise nilesoft-shell onefetch pandoc ripgrep starship tlrc tokei wireshark xmake zoxide"
