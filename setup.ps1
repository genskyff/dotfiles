...
$scoop_list = "7zip bat bun delta fastfetch git gsudo lazydocker lazygit less liberica-full-lts-jdk llvm lsd nilesoft-shell onefetch pandoc python ripgrep starship tokei w64devkit wireshark xmake zoxide"
