...
$scoop_list = "7zip bat bun delta fastfetch git gsudo lazygit less liberica-full-lts-jdk llvm lsd nilesoft-shell pandoc python ripgrep starship tokei w64devkit wireshark xmake zoxide"
