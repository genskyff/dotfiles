...
$scoop_list = "7zip bat bun delta fastfetch git gsudo lazydocker lazygit less llvm lsd nilesoft-shell onefetch pandoc ripgrep starship tokei w64devkit wireshark xmake zoxide"
